...
export default function SettingsPage() {
  const [user, setUser] = useState({
    ...
    experience: "5",
    bio: "Passionate full-stack developer with expertise in React, Node.js, and cloud technologies. Love solving complex problems and mentoring junior developers.",
          ...
          <TabsContent value="profile" className="space-y-6">
            ...
            <Card className="bg-black/40 border-green-500/20 backdrop-blur-xl">
              ...
              <CardContent className="flex items-center space-x-6">
                ...
                <div>
                  <p className="text-white font-mono font-bold">{user.name}</p>
