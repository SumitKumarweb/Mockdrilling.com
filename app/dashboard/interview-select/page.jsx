  ...
  const handleProceed = () => {
    if (canProceed) {
      if (selectedOption === "take") {
        window.location.href = `/dashboard/interview/take/${selectedDomain}`
      } else {
        window.location.href = `/dashboard/interview/give/${selectedDomain}`
      }
    }
  }
              ...
              return (
                <Card
                  ...
                  className={`cursor-pointer transition-all duration-300 ${
                    isSelected
                      ? `bg-${option.color}-500/20 border-${option.color}-500/50 shadow-lg`
                  ...
                  <CardHeader>
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        <div
                          className={`w-12 h-12 bg-${option.color}-500/20 rounded-lg flex items-center justify-center`}
                        >
              ...
              {domains.map((domain) => {
                ...
                return (
                  <Card
                    ...
                    className={`cursor-pointer transition-all duration-300 ${
                      isSelected
                        ? `bg-${domain.color}-500/20 border-${domain.color}-500/50 shadow-lg`
                        : "bg-black/40 border-gray-600/30 hover:border-gray-500/50"
                    }`}
                  ...
                  >
                    <CardContent className="p-6 text-center">
                      <div
                        className={`w-16 h-16 bg-${domain.color}-500/20 rounded-lg flex items-center justify-center mx-auto mb-4`}
                      >
                        <Icon className={`w-8 h-8 text-${domain.color}-400`} />
                      </div>
